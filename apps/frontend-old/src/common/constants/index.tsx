...
import { citizenShipAccounts } from './citizenship';
import { tutorAccounts } from './tutor';

import { SwapSetting } from '../../types';
import { resourceAccounts } from './resources-swap';
...
export const TOKEN_SWAP_STATE_ACCOUNTS: Record<string, SwapSetting> = {
  ...
  ...resourceAccounts['mainnet-beta'].normal,
};
...
export const DEVNET_TOKEN_SWAP_STATE_ACCOUNTS: Record<string, SwapSetting> = {
  ...
  ...resourceAccounts['devnet'].normal,
};
